...
// int check(vector<int>*edges ,bool*visited,int*arr,int start,int ans,int n)
// {
//     //     do dfs and add value from array
//    visited[start]=true;
//     ans += arr[ans-1];
     
//     auto it = edges[start].begin();
//     for(auto i=it;i!=edges[start].end();i++)
//         {
//             if(!visited[*i])
//             {
//                 check(edges,visited,arr,*i,ans,n);
//             }
//         }
...
//             if(!visited[i])
//             {
//                ans=max(ans,check(edges,visited,arr,0,ans,n) );
//             }
//         }
